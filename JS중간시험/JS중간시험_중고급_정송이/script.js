...
scores.push([subject.math])
scores.push([subject.eng])
scores.push([subject.science])
...
const num = getAvg(scores)
var avg = Math.round(num)

console.log(`3번 문제 정답: ${avg}점`)
/*
